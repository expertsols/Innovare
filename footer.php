...
<footer id="colophon" class="site-footer andromeda-footer">
		...
		<div class="container">
			<div class="row gy-4">
				...
				<div class="col-lg-4 col-md-12">
					<div class="footer-brand">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" aria-label="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
							<?php andromeda_brand_logo( 'footer' ); ?>
						</a>
					</div>
					...
					<?php andromeda_social_icons( 'footer-socials' ); ?>
				</div>
				...
				<div class="col-lg-2 col-md-3 col-6">
					...
					<?php else : ?>
						<ul class="footer-links">
							<li><a href="<?php echo esc_url( andromeda_page_url( andromeda_about_page_slug() ) ); ?>"><?php esc_html_e( 'About Us', 'innovare' ); ?></a></li>
							<li><a href="<?php echo esc_url( andromeda_page_url( andromeda_about_page_slug() ) ); ?>#industries"><?php esc_html_e( 'Industries Served', 'innovare' ); ?></a></li>
							<li><a href="<?php echo esc_url( andromeda_page_url( 'insights' ) ); ?>"><?php esc_html_e( 'Insights', 'innovare' ); ?></a></li>
							<li><a href="<?php echo esc_url( andromeda_page_url( 'contact' ) ); ?>"><?php esc_html_e( 'Contact', 'innovare' ); ?></a></li>
						</ul>
					<?php endif; ?>
				</div>
				...
				<div class="col-lg-2 col-md-3 col-6">
					...
					<?php else : ?>
						<ul class="footer-links">
							<li><a href="<?php echo esc_url( andromeda_page_url( 'services' ) ); ?>#managed"><?php esc_html_e( 'Managed IT', 'innovare' ); ?></a></li>
							<li><a href="<?php echo esc_url( andromeda_page_url( 'services' ) ); ?>#infrastructure"><?php esc_html_e( 'Infrastructure', 'innovare' ); ?></a></li>
							<li><a href="<?php echo esc_url( andromeda_page_url( 'services' ) ); ?>#security"><?php esc_html_e( 'Security', 'innovare' ); ?></a></li>
							<li><a href="<?php echo esc_url( andromeda_page_url( 'services' ) ); ?>#consulting"><?php esc_html_e( 'Consulting', 'innovare' ); ?></a></li>
						</ul>
					<?php endif; ?>
				</div>
				...
				<div class="col-lg-2 col-md-3 col-6">
					...
					<?php else : ?>
						<ul class="footer-contact">
							<li><?php andromeda_icon( 'pin' ); ?> <span><?php echo esc_html( $address ); ?></span></li>
							...
							<?php if ( $whatsapp ) : ?>
								<li><?php andromeda_icon( 'whatsapp' ); ?> <a href="https://wa.me/<?php echo esc_attr( preg_replace( '/[^\d]/', '', $whatsapp ) ); ?>" target="_blank" rel="noopener"><?php echo esc_html( $whatsapp ); ?></a></li>
							<?php endif; ?>
						</ul>
					<?php endif; ?>
				</div>
	...
	<div class="footer-bottom">
		<div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
			...
			if ( has_nav_menu( 'footer' ) ) {
				...
				printf( '<li><a href="%s">%s</a></li>', esc_url( andromeda_privacy_policy_url() ), esc_html__( 'Privacy', 'innovare' ) );
				printf( '<li><a href="%s">%s</a></li>', esc_url( andromeda_page_url( 'terms' ) ), esc_html__( 'Terms', 'innovare' ) );
				printf( '<li><a href="%s">%s</a></li>', esc_url( andromeda_page_url( 'sitemap' ) ), esc_html__( 'Sitemap', 'innovare' ) );
				echo '</ul>';
			}
			?>
		</div>
